    ...
    <section className={`${styles.flexCenter} ${styles.paddingY} 
     flex-col`}>
      ...
      mb-8 2-full`}>
        ...
        className='w-[266px] h-[72px] object-contain'
         ...
         <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>
          Uma nova maneira de fazer facilmente seus pagamento, rápido e seguro.
         </p>
        </div>
        ...
        <div className="flex-[1.5] w-full flex flex-row justify-between flex-wrap
         md:mt-0 mt-10">
          {footerLinks.map((footerLink) => (
            <div key={footerLink.key} className="flex flex-col ss:my-0 my-0
             min-w-[150px]">
      ...
      flex-col pt-6 border-t-[1px] border-t-[#3f3r45]'>
        ...
        leading-[27px]
        text-white'>
          2022 HooBank. Desenvolvedor Cadu Gomes!
        </p>
