  ...
  return (
    <section id='features' className={layout.section}> 
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Você faz os negócios, 
          <br className='sm:block hidden'></br>
           e nós cuidamos do dinheiro.
        </h2>
         <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Com o cartão de crédito certo, você pode melhorar
          sua vida financeira, ganhando recompensas e
           poupando dinheiro. Com o melhor cartão do mercado.
         </p>
