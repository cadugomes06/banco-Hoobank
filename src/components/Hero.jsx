        ...
        <div className={`flex-1 ${styles.flexStart}
          flex-col xl:px-0 sm:px-16 px-6`}>
           ...
           <h1 className='font-poppins font-semibold
               ...
               ss:leading-[100px] leading-[75px] w-full pb-0'>
               de pagamento.   
           </h1> 
           <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Nosso time de profissionais utilizam 
            uma metodologia para identificar os cartões
            de créditos que irão resolver suas necessidades.
            Nós fazemos análises anuais dos indicadores
            e taxas.
            </p>
      </div>

      <div className={`flex-1 flex ${styles.flexCenter} 
       med:my-0 my-0 relative`}>
        ...
        <div className='absolute z-[0] w-[40%] h-[35%]
         ...
         <div className='absolute z-[1] w-[80%] h-[80%]
          rounded-full bottom-40 white__gradient pink__gradient' />
